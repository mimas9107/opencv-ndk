...
這份 task 對應的是 OCR MVP 第一輪已驗證 checkpoint。
目前可確認 build、assets、APK packaging、preview 保護、裝置端 OCR 結果、ROI gate 調整與節流調整；後續若要擴大場景，應以更多文字樣本做回歸。
